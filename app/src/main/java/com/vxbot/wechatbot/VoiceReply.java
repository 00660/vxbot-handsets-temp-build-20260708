...
final class VoiceReply {
    private static final int VOICE_SEGMENT_TARGET_MS = 3200;
    private static final int VOICE_SEGMENT_MAX_MS = 3600;
    private static final int VOICE_SEGMENT_RETRY_TARGET_MS = 2800;
    ...
    private static int maxSegmentChars(float speechRate) {
        ...
        return Math.max(10, Math.min(220, max));
    }
